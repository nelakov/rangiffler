...
export const PhotoCard: FC<PhotoCardInterface> = ({
  photo,
  onClose,
  initSubmitPopupAndOpen,
}) => {
  ...
  const { handleAddPhoto, handleEditPhoto, handleDeletePhoto } =
  ...
  const [photoData, setPhotoData] = useState<Partial<Photo>>(
    photo ?? initialPhotoCard
  );
  ...
  const onDeleteClick = (photo: Partial<Photo>) => {
    initSubmitPopupAndOpen(
      "You are going to delete photo. Are you sure?",
      "Delete",
        ...
        <Card>
          ...
          >
            {edit ? (
              <>
                <form
                  onSubmit={!photo ? handleAddPhotoClick : handleEditPhotoClick}
                >
                  <Grid
                    container
                    direction="column"
              ...
              <>
                ...
                <Typography gutterBottom variant="h6" component="p">
                  <PlaceIcon sx={{ verticalAlign: "text-top" }} />
